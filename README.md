...
The following diagram shows the evolution of the decisions the Discriminator made over the first 100 epochs in our test run.<br />
<img src="evolution discriminator.PNG"><br />
