...
In the following animation you can see the process of our logger output from epoch 0 to 400 when running the GAN. In the beginning the images generated are pixel mud but they get better over time…

That is the output of the logger in epoch 0.

<img src="GANfirst.png">

That is the output of the logger in epoch 400.

<img src="GANlast.png">

That is the whole output of the logger from epoch 0 to epoch 400.
